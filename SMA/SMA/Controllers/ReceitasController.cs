...
namespace SMA.Controllers
{
    public class ReceitasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Data,Prescricao")] Receita receita)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Data,Prescricao")] Receita receita)
        {
            if (id != receita.Id)
            {
                return NotFound();
