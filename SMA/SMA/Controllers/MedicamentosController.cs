    ...
    public class MedicamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Dosagem,Laboratorio,Observacoes,Foto")] Medicamento medicamento, IFormFile foto)
        {
            ...
            if (foto == null) { 
                ...
                if (!(foto.ContentType == "image/png" || foto.ContentType == "imagem/jpeg")) {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Dosagem,Laboratorio,Observacoes,Foto")] Medicamento medicamento)
        {
